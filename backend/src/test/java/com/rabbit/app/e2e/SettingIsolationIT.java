...
public class SettingIsolationIT extends E2eTestSupport {
    ...
    void userDefaultsAreSnapshottedWhenHousesAreCreatedAndRemainIsolated() {
        ...
        assertSetting(firstInitial.get("setting"), 11, 22, 31, 4, 26, 9, 33, 44);
        ...
        assertSetting(firstAfterUserUpdate.get("setting"), 11, 22, 31, 4, 26, 9, 33, 44);
        ...
        assertSetting(secondInitial.get("setting"), 12, 23, 32, 5, 27, 10, 34, 45);
        ...
        assertSetting(firstAfterHouseUpdate.get("setting"), 61, 62, 63, 64, 65, 66, 67, 68);
        JsonNode secondAfterHouseUpdate = api.getOk("/api/house-settings", owner.token, secondHouse);
        assertSetting(secondAfterHouseUpdate.get("setting"), 12, 23, 32, 5, 27, 10, 34, 45);

        JsonNode userSetting = api.getOk("/api/settings", owner.token, null);
        assertSetting(userSetting, 12, 23, 32, 5, 27, 10, 34, 45);
    }
    ...
    private void assertSetting(JsonNode setting, int aphrodisiac, int palpation,
        ...
        Assertions.assertEquals(gestation, setting.get("gestationDays").asInt());
