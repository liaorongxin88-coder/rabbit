...
public class BatchService {
    ...
    public void pregnancyCheck(Long userId, Long houseId, Long batchId, Long rabbitId, Date checkDate, String result, String remark, String requestId) {
        ...
        if ("怀孕".equals(result)) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "怀孕确认", "摸胎", record.getId(), "pregnancy_check_records");
            requestDedupService.markDone(houseId, userId, api, requestId);
            return;
        }
        if ("空怀".equals(result)) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "空怀", "摸胎", record.getId(), "pregnancy_check_records");
        ...
        insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "不确定", "摸胎", record.getId(), "pregnancy_check_records");
        requestDedupService.markDone(houseId, userId, api, requestId);
        } catch (RuntimeException e) {
            requestDedupService.markFailed(houseId, userId, api, requestId, e.getMessage());
            throw e;
    ...
    public void prepartumFinish(Long userId, Long houseId, Long batchId, Long rabbitId, Date actionDate, String remark, String requestId) {
        ...
        insertHistoryAt(userId, houseId, batchId, rabbitId, br.getCurrentStatus(), br.getCurrentStatus(), "备产完成", actionDate, record.getId(), "prepartum_records");
        requestDedupService.markDone(houseId, userId, api, requestId);
        } catch (RuntimeException e) {
            requestDedupService.markFailed(houseId, userId, api, requestId, e.getMessage());
            throw e;
    ...
    public void parturition(Long userId, Long houseId, Long batchId, Long rabbitId, Date birthDate, int totalKits, int liveKits, boolean failed, String remark, String requestId) {
        ...
        if (failed) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "分娩失败", "分娩", record.getId(), "parturition_records");
        ...
        insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "哺乳中", "分娩", record.getId(), "parturition_records");
        requestDedupService.markDone(houseId, userId, api, requestId);
        } catch (RuntimeException e) {
            requestDedupService.markFailed(houseId, userId, api, requestId, e.getMessage());
            throw e;
    ...
    public void weaning(Long userId, Long houseId, Long batchId, Long rabbitId, Date weaningDate, int weaningCount, Integer maleCount, Integer femaleCount, Long targetCageId, Double avgWeight, String remark, String requestId) {
        ...
        insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "休整期", "断奶", record.getId(), "weaning_records");
    ...
    public void aphrodisiacStart(Long userId, Long houseId, Long batchId, List<Long> rabbitIds, String requestId) {
        ...
        for (Long rabbitId : rabbitIds) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "催情中", "催情开始", null, null);
        }
        requestDedupService.markDone(houseId, userId, api, requestId);
        } catch (RuntimeException e) {
            requestDedupService.markFailed(houseId, userId, api, requestId, e.getMessage());
    ...
    public void aphrodisiacFinish(Long userId, Long houseId, Long batchId, List<Long> rabbitIds, String requestId) {
        ...
        for (Long rabbitId : rabbitIds) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, fromStatus, "待配种", "催情完成", null, null);
        }
        requestDedupService.markDone(houseId, userId, api, requestId);
        } catch (RuntimeException e) {
            requestDedupService.markFailed(houseId, userId, api, requestId, e.getMessage());
    ...
    public void sale(Long userId, Long houseId, Long batchId, List<Long> rabbitIds, Date saleDate, String remark, String requestId) {
        ...
        for (Long rabbitId : rabbitIds) {
            ...
            insertHistory(userId, houseId, batchId, rabbitId, br.getCurrentStatus(), "已出售", "出售", null, null);
        }
    ...
    private void insertHistory(Long userId, Long houseId, Long batchId, Long rabbitId, String fromStatus, String toStatus, String reason, Long relatedId, String relatedTable) {
        RabbitStatusHistory h = new RabbitStatusHistory();
        h.setHouseId(houseId);
    ...
    private void insertHistoryAt(Long userId, Long houseId, Long batchId, Long rabbitId, String fromStatus, String toStatus, String reason, Date changeTime, Long relatedId, String relatedTable) {
        RabbitStatusHistory h = new RabbitStatusHistory();
        h.setHouseId(houseId);
        h.setRabbitId(rabbitId);
        h.setBatchId(batchId);
