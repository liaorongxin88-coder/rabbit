...
public enum PermissionCode {
    ...
    PLATFORM_APP_RELEASES_LIST("platform:app-releases:list", PermissionScope.PLATFORM, PlatformRole.ADMIN.rank()),
    PLATFORM_APP_RELEASES_QUERY("platform:app-releases:query", PermissionScope.PLATFORM, PlatformRole.ADMIN.rank()),
    PLATFORM_APP_RELEASES_ADD("platform:app-releases:add", PermissionScope.PLATFORM, PlatformRole.ADMIN.rank()),
    PLATFORM_APP_RELEASES_EDIT("platform:app-releases:edit", PermissionScope.PLATFORM, PlatformRole.ADMIN.rank()),
