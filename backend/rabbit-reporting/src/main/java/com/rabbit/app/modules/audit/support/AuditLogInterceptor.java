...
public class AuditLogInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
        ...
        log.setUserId(context == null ? AuthContext.getUserId() : context.getUserId());
        log.setHouseId(context == null ? parseHouseId(request.getHeader("X-House-Id")) : context.getHouseId());
        log.setBatchId(context == null ? null : context.getBatchId());
        log.setCageId(context == null ? null : context.getCageId());
        log.setRabbitId(context == null ? null : context.getRabbitId());
