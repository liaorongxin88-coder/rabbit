...
class BatchSheetLoadingState extends StatelessWidget {
  const BatchSheetLoadingState({
    super.key,
...
class BatchSheetErrorState extends StatelessWidget {
  const BatchSheetErrorState({
    super.key,
    required this.sheetTitle,
    required this.error,
