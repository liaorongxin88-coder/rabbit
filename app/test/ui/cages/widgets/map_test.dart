...
void main() {
  testWidgets('cage management only renders the layered map', (tester) async {
    ...
    expect(find.byKey(const ValueKey('cage-view-map-toggle')), findsNothing);
    expect(find.byKey(const ValueKey('cage-view-list-toggle')), findsNothing);
    expect(find.text('分层笼位图'), findsOneWidget);
