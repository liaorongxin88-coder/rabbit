...
const WorkspaceBatchDetailPage = lazy(() =>
  import("@/pages/workspace-batch-detail-page").then((module) => ({
    default: module.WorkspaceBatchDetailPage,
  })),
);
  ...
  return (
    <AppShell session={session} onLogout={handleLogout}>
      <Routes>
        ...
        <Route
          path="/merchants/:legacyId"
          element={<Navigate to="/farms" replace />}
        />
        <Route
          path="/accounts"
          element={
    ...
    <WorkspaceProvider session={session}>
      <WorkspaceShell onLogout={handleLogout}>
        <Routes>
          ...
          <Route
            path="livestock/rabbits/:rabbitId"
            element={<WorkspaceRabbitDetailPage />}
          />
          <Route path="production" element={<WorkspaceProductionPage />} />
          <Route
            path="production/batches/:batchId"
            element={<WorkspaceBatchDetailPage />}
          />
...
function LegacyWorkspaceRedirect() {
  ...
  return (
    <Navigate to={`${destination}${location.search}${location.hash}`} replace />
  );
}
    ...
    <>
      ...
      >
        <Routes>
          ...
          <Route
            path="/merchant/login"
            element={<Navigate to="/workspace/login" replace />}
          />
