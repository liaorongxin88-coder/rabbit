...
```bash
dot -Tsvg docs/app/modules/window-state-transitions.dot \
  -o docs/app/modules/window-state-transitions.svg
dot -Tsvg docs/app/modules/window-state-overlays.dot \
  -o docs/app/modules/window-state-overlays.svg
dot -Tsvg docs/app/modules/window-state-derivation.dot \
  -o docs/app/modules/window-state-derivation.svg
```
